public class lerAcopiarParaB {
     ...
     */
     ...
     public static void aParaOb(String conteudoA, String arquivoB, String conteudoB ){
        ...
        Arq.println(conteudoB); // escrever o conteudo que ja estava contido dentro dele 
        Arq.println(conteudoA); // escrever o conteudo que estava presente no arquivo A
